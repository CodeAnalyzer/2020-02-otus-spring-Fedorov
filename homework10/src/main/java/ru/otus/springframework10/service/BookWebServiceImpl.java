...
import ru.otus.springframework10.exception.AuthorFoundTooManyException;
import ru.otus.springframework10.exception.GenreFoundTooManyException;
import ru.otus.springframework10.repository.AuthorRepository;
import ru.otus.springframework10.repository.BookRepository;
import ru.otus.springframework10.repository.GenreRepository;
...
public class BookWebServiceImpl implements BookWebService{
    ...
    @Override
    @Transactional
    public Book insert(String authorName, String genreName, String bookTitle) {
