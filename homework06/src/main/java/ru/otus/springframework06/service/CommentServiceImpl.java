...
import ru.otus.springframework06.repository.BookRepository;
import ru.otus.springframework06.repository.CommentRepository;
...
public class CommentServiceImpl implements CommentService{
    ...
    public void insert() {
        ...
        commentRepository.insert(new Comment(0L, book.get(), remark));
    }
    ...
    public boolean ServiceAvailable() {
        return bookRepository.getCount() > 0 ;
    }
}
